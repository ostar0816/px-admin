...
@Directive({
  selector: '[pyxisPerfectScrollbar]'
})
export class PyxisPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    this.onConfigChanged =
      this.pyxisConfig.onConfigChanged.subscribe(
        (settings) => {
