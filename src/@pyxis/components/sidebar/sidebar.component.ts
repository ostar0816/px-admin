...
import { PyxisSidebarService } from './sidebar.service';
...
@Component({
  selector: 'pyxis-sidebar',
  templateUrl: './sidebar.component.html',
  styleUrls: ['./sidebar.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PyxisSidebarComponent implements OnInit, OnDestroy {
  // Name
  @Input()
  name: string;
   ...
   * @param {PyxisConfigService} pyxisConfigService
   * @param {PyxisSidebarService} pyxisSidebarService
   * @param {PyxisMatchMediaService} pyxisMatchMediaService
   */
  constructor(
    ...
    private pyxisConfigService: PyxisConfigService,
    private pyxisSidebarService: PyxisSidebarService,
    private pyxisMatchMediaService: PyxisMatchMediaService
  ) {
    // Set the defaults
    this.opened = false;
    this.folded = false;
  ...
  ngOnInit(): void {
    ...
    this.pyxisSidebarService.register(this.name, this);
  ...
  ngOnDestroy(): void {
    ...
    this.pyxisSidebarService.unregister(this.name);
  ...
  private _setupLockedOpen(): void {
    ...
    this._onMediaChangeSubscription =
      ...
      this.pyxisMatchMediaService.onMediaChange.subscribe(() => {
        ...
        if (isActive) {
          ...
          if (this.pyxisConfigService.config.layout.navigationFolded) {
            this.fold();
          }
  ...
  showBackdrop(): void {
    ...
    this._backdrop.classList.add('pyxis-sidebar-overlay');
