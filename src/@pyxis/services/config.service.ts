...
const DEFAULT_CONFIG = {
  ...
  colorClasses: {
    ...
    navbar: 'mat-pyxis-dark-700-bg',
    footer: 'mat-pyxis-dark-900-bg'
  },
...
export const PYXIS_CONFIG = new InjectionToken('pyxisCustomConfig');

@Injectable()
export class PyxisConfigService {
  config: any;
  defaultConfig: any;
  ...
  constructor(
    ...
    @Inject(PYXIS_CONFIG) @Optional() config
  ) {
